    ...
    <div className="App">
      <div className="stopwatch-container">
        <ul className="stopwatch">
          <li><h3 className="title">Hours</h3>{getTime(time).hours.padStart(2, "0")}</li>
          <li><h3 className="title">Minutes</h3>{getTime(time).minutes.padStart(2, "0")}</li>
          <li><h3 className="title">Seconds</h3>{getTime(time).seconds.padStart(2, "0")}</li>
        </ul>
